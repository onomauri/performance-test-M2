...
This project is a **performance assesment** focused on building a responsive landing page for a rock band.
...
* Are included the following sections:
...
## 📱 Responsive Design
 ...
 site **adapt** to different screen sizes.
